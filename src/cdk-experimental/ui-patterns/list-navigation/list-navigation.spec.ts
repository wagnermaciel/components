...
describe('List Navigation', () => {
  ...
  describe('#isFocusable', () => {
    it('should return true for enabled items', async () => {
      ...
      expect(await nav.isFocusable(nav.items()[0])).toBeTrue();
      expect(await nav.isFocusable(nav.items()[1])).toBeTrue();
      expect(await nav.isFocusable(nav.items()[2])).toBeTrue();
    });
    ...
    it('should return false for disabled items', async () => {
      ...
      expect(await nav.isFocusable(nav.items()[0])).toBeTrue();
      expect(await nav.isFocusable(nav.items()[1])).toBeFalse();
      expect(await nav.isFocusable(nav.items()[2])).toBeTrue();
    });
