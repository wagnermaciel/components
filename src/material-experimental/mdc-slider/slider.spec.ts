...
describe('MDC-based MatSlider', () => {
  ...
  function checkInput(
    ...
    expect(input.translateX).withContext('translateX').toBeCloseTo(translateX, 0);
    if (step !== undefined) {
    ...
    if (width !== undefined) {
      ...
      expect(realWidth).withContext('width').toBeCloseTo(width, 0);
    }
  }
  ...
  describe('range slider with min/max bindings', () => {
    ...
    describe('should handle min changes', () => {
      ...
      it('where the new start tx is greater than the old end tx', () => {
        ...
        checkInput(startInput, {min: -1000, max: 20, value: 10, translateX: 275, width: 92});
    ...
    describe('should handle max changes', () => {
      ...
      it('where the new end tx is less than the old start tx', () => {
        ...
        checkInput(startInput, {min: 0, max: 95, value: 90, translateX: 27, width: 9});
  ...
  //     setValueByClick(slider, input, 60, platform.IOS);
  //     slideToValue(slider, 60, platform.IOS);
  //     setValueByClick(slider, input, 60, platform.IOS);
  //     slideToValue(slider, 60, platform.IOS);
  ...
  //     expect(testComponent.onStartThumbChange).not.toHaveBeenCalled();
  //     expect(testComponent.onEndThumbChange).not.toHaveBeenCalled();
  //     setValueByClick(slider, endInput, 80, platform.IOS);
  //     expect(testComponent.onStartThumbChange).not.toHaveBeenCalled();
  ...
  //     expect(testComponent.onStartThumbChange).not.toHaveBeenCalled();
  //     expect(testComponent.onEndThumbChange).not.toHaveBeenCalled();
  //     slideToValue(slider, 40, Thumb.START, platform.IOS);
  //     expect(testComponent.onStartThumbChange).toHaveBeenCalledTimes(1);
  //     expect(testComponent.onEndThumbChange).not.toHaveBeenCalled();
  //   });
  ...
  //     setValueByClick(slider, startInput, 30, platform.IOS);
  //     slideToValue(slider, 30, Thumb.START, platform.IOS);
  //     setValueByClick(slider, startInput, 30, platform.IOS);
  //     slideToValue(slider, 30, Thumb.START, platform.IOS);
  ...
  //     setValueByClick(slider, endInput, 60, platform.IOS);
  //     slideToValue(slider, 60, platform.IOS);
  //     setValueByClick(slider, endInput, 60, platform.IOS);
  //     slideToValue(slider, 60, platform.IOS);
  ...
  //     const sliderDebugElement = fixture.debugElement.query(By.directive(MatSlider));
  //     slider = sliderDebugElement.componentInstance;
  //     sliderElement = slider._elementRef.nativeElement;
  //   }));
  ...
  //     setValueByClick(slider, input, 30, platform.IOS);
  ...
  //     setValueByClick(slider, input, 55, platform.IOS);
  ...
  // xdescribe('range slider with a two-way binding', () => {
  //   let slider: MatSlider;
  //   let startInput: MatSliderRangeThumb;
  //   let endInput: MatSliderRangeThumb;
...
function setValueByClick(
  ...
  const sliderElement = input._elementRef.nativeElement;
  const {x, y} = getCoordsForValue(slider, value);

  dispatchPointerOrTouchEvent(sliderElement, PointerEventType.POINTER_DOWN, x, y, isIOS);
  input.value = isRtl ? slider.max - value : value;
